...
//definitions
Box2D.postDefs = [];
(function () {//b2DynamicTree //b2Collision //b2AABB
	...
	b2SeparationFunction.prototype.Initialize = function (cache, proxyA, transformA, proxyB, transformB) {
		...
		if (count == 1) {
			...
			var denom = a * e - b * b;
			s = 0.0;
			if (denom != 0.0) s = b2Math.Clamp((b * f - c * e) / denom, 0.0, 1.0);
			var t = (b * s + f) / e;
			if (t < 0.0) {
				t = 0.0;
...
(function () {//b2Shape //b2PolygonShape //b2CircleShape
	var b2Color = Box2D.Common.b2Color;
	var b2internal = Box2D.Common.b2internal;
	var b2Settings = Box2D.Common.b2Settings;
	var b2CircleShape = Box2D.Collision.Shapes.b2CircleShape;
...
(function () {//b2Body //b2Fixture //b2World
	...
	b2World.prototype.SolveTOI = function (step) {
		var b, c, fA, fB, bA, bB, cEdge, j, island = this.m_island;
		...
		for (;;) {
			var minContact = null, minTOI = 1.0;
			for (c = this.m_contactList; c; c = c.m_next) {
			...
			while (queueSize > 0) {
				...
				for (var jEdge = b.m_jointList; jEdge; jEdge = jEdge.next) {
					if (island.m_jointCount == island.m_jointCapacity || jEdge.joint.m_islandFlag == true) continue;
					other = jEdge.other;
			...
			var i, subStep = b2World.s_timestep;
			...
			for (i = 0; i < island.m_bodyCount; ++i) {
				b = island.m_bodies[i];
				b.m_flags &= ~b2Body.e_islandFlag;
				if (b.IsAwake() == false || b.GetType() != b2Body.b2_dynamicBody) continue;
				b.SynchronizeFixtures();
				for (cEdge = b.m_contactList; cEdge; cEdge = cEdge.next) {
	...
	b2World.prototype.DrawJoint = function (joint) {
		var b1 = joint.GetBodyA(), b2 = joint.GetBodyB(), xf1 = b1.m_xf, xf2 = b2.m_xf, x1 = xf1.position, x2 = xf2.position, p1 = joint.GetAnchorA(), p2 = joint.GetAnchorB(), color = b2World.s_jointColor;
		switch (joint.m_type) {
...
(function () {//b2Joint //b2FrictionJoint //b2DistanceJoint
	var b2Color = Box2D.Common.b2Color;
	var b2internal = Box2D.Common.b2internal;
	var b2Settings = Box2D.Common.b2Settings;
	var b2Mat22 = Box2D.Common.Math.b2Mat22;
...
for(var i=0; i<Box2D.postDefs.length; ++i) Box2D.postDefs[i]();
